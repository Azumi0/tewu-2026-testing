...
|----------|----------|-------|-------|
| Breaking/Hydration | 3 | - | - |
| Accessibility | - | 5 | - |
| React 19/Next.js 16 | - | - | 4 |
| Mantine v8 | - | - | 3 |
| Performance | - | 2 | - |

### Priority Actions

1. **High:** Fix DOM manipulation hydration issues (CR-001, CR-003)
2. **High:** Add `aria-label` to all icon-only buttons (A11Y-001, A11Y-004)
3. **Medium:** Add `title` to iframe (A11Y-002)
4. **Medium:** Consider converting static components to Server Components (OPT-001)
5. **Low:** Migrate external images to Next.js Image component (PERF-001)
6. **Low:** Consolidate hardcoded styles into theme.ts (MANTINE-001, MANTINE-003)
