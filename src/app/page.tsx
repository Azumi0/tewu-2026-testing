        ...
        <div className="flex flex-col">
            ...
            <section className="py-24 bg-slate-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {SERVICES.slice(0, 4).map((service) => (
                        <div key={service.id} className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all group border border-slate-100">
                            ...
                            <Link href="/uslugi" className="text-blue-600 font-bold text-sm inline-flex items-center hover:gap-2 transition-all">
                ...
                <div className="mt-16 text-center">
                    <Link href="/uslugi" className="inline-flex items-center text-slate-900 font-black hover:text-blue-600 transition-colors">
